...
| `education_level` | Typical entry-level education (BLS categories, e.g. "Bachelor's degree"). Collapsed in-notebook to three tiers — high school or below / bachelor's / master's or above. |
